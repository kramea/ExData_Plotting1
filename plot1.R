...
## Histogram of Global Active Power is plotted and saved as png file
hist(final_power[,3], col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
